...
public class Application {
    ...
    private void deleteBeerFromPub() {
        ...
        Beer beerToDelete = server.find(Beer.class).where().like("name", beer).findUnique();
        ...
        pubToFind.removeBeer(beerToDelete);
        System.out.println("deleted: " + beerToDelete + " from pub: " + pubToFind.getName());
